...
const Dashboard = () => {
    ...
    return (
        ...
        <View style={styles.container}>
            <View>
            <Image source={require('../asset/Rectangle21.png')}
                    style={styles.background1}
                />
                <Image source={require('../asset/Ellipse1.png')}
                    style={styles.background}
                />
                <Image source={require('../asset/Vector1.png')}
                    resizeMode='center'
                    style={styles.logo}
                />
                ...
                <TouchableOpacity>
                    <Image source={require('../asset/Ellipse3.png')}
                        style={{
                    ...
                    <Text style={{
                        ...
                        onPress={() => navigation.navigate('ProfileScreen')}>A</Text>
                </TouchableOpacity>
            </View>
            <ScrollView>
            <View style={styles.wrapper}>
                ...
                >
                    <Image source={require('../asset/image4.png')}
                        style={styles.slide}
                    />
                    <Image source={require('../asset/image4.png')}
                        resizeMode='stretch'
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                <View>
                    <Image source={require('../asset/fxemoji_cat.png')}
                ...
                <View>
                    <Image source={require('../asset/Pdog.png')}
                        style={{ width: 60, height: 60, borderRadius: 30, marginHorizontal: 10, borderWidth: 1, borderColor: '#CACACA', elevation: 5 }}
                    />
                    <Text style={{ alignSelf: 'center' }}>Anjing</Text>
                </View>
                <View>
                    <Image source={require('../asset/noto_hamster.png')}
                        style={{ width: 60, height: 60, borderRadius: 30, marginHorizontal: 10, borderWidth: 1, borderColor: '#CACACA', elevation: 5 }}
                    />
                    <Text style={{ alignSelf: 'center' }}>Hamster</Text>
                </View>
                <View>
                    <Image source={require('../asset/twemoji_rabbit-face.png')}
                        style={{ width: 60, height: 60, borderRadius: 30, marginHorizontal: 10, borderWidth: 1, borderColor: '#CACACA', elevation: 5 }}
                    />
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 30 }}>
                ...
                <Text style={{ right: 25 }}
                    onPress={() => navigation.navigate('SearchbarScreen')}>Lihat lainnya {">>"}</Text>
            </View>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'center', marginTop:20 }}>
                ...
                <View style={styles.banyak}>
                    <Image source={require('../asset/image4.png')} style={styles.picture} />
                    <Text style={{
                        fontSize: 15,
                        color: '#875C25',
                        marginStart: 5,
